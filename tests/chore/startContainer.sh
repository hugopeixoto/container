...
docker ps -f id=$(docker run -d --name hedgedoc --network postgres -p 127.0.0.1:${PORT}:3000 -e "HMD_DB_URL=postgres://hedgedoc:password@database:5432/hedgedoc" hedgedoc)
